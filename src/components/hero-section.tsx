      ...
      <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="flex-1 text-center lg:text-left mb-10 lg:mb-0">
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-serif font-light mb-6 tracking-wider leading-tight">
              <span className="text-gradient-gold">Aesthetics</span> Rebellion
              <span className="block mt-2">Metaverse</span>
            </h1>
            <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto lg:mx-0 mb-8 font-serif">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <ChromeButton variant="gold" size="lg" className="flex items-center justify-center gap-2">
                <Rocket size={20} />
                <span className="font-serif">Enter Metaverse</span>
              </ChromeButton>
              <ChromeButton variant="chrome" size="lg" className="flex items-center justify-center gap-2">
                <Globe size={20} />
                <span className="font-serif">Explore Worlds</span>
              </ChromeButton>
            </div>
            
            <div className="mt-12 flex flex-wrap justify-center lg:justify-start gap-8">
              <div className="text-center">
                <p className="text-3xl font-serif font-light text-gradient-gold">25K+</p>
                <p className="text-sm text-white/60 font-serif">Active Users</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-serif font-light text-gradient-gold">100+</p>
                <p className="text-sm text-white/60 font-serif">Virtual Worlds</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-serif font-light text-gradient-gold">500K+</p>
                <p className="text-sm text-white/60 font-serif">NFTs Created</p>
              </div>
            </div>
          </div>
